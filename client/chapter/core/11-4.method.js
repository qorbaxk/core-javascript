...
// 체이닝
// 메소드 자체에서 계속 this를 반환하면, 앞에 객체를 써주지않아도 연달아 작성이 가능하다.
// ladder.up().up() 이렇게 up() 자체가 this를 반환하기 때문에 this.up()이 되는것
let ladder = {
  step: 0,
  up() {
    this.step++;
